...
public class MainActivity extends AppCompatActivity {
    ...
    private MaterialButton _btnTampilkan, _btnViewCityInfo;
    ...
    private void bindRecyclerView1() {
        ...
        ahc.get(url, new AsyncHttpResponseHandler()
        {
            ...
            {
                // Menampilkan JSON mentah ke Logcat
                //Log.d("ta", new String(responseBody));
    ...
    private void initButtonViewCityInfo() {
        _btnViewCityInfo = findViewById(R.id.btnView_cityInfo);

        _btnViewCityInfo.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    private void initCityInfo() {
        ...
        _btnViewCityInfo.setText(cityInfo);
    }
